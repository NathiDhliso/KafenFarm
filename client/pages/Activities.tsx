      ...
      <section className="relative">
        <div className="absolute inset-0 -z-10">
          <img
            ...
            srcSet="/KafenFarmPics/KafenFarm_Grass_Picnic_005_mobile.webp 600w, /KafenFarmPics/KafenFarm_Grass_Picnic_005.webp 1200w"
            sizes="100vw"
      ...
      <section className="container py-12 space-y-12">
        <div id="trails" className="grid gap-6 md:grid-cols-2 items-center">
          ...
          <div className="rounded-xl overflow-hidden border shadow-card">
            <img
              src="/KafenFarmPics/KafenFarm_Candid_Moments_003.webp"
              srcSet="/KafenFarmPics/KafenFarm_Candid_Moments_003_mobile.webp 600w, /KafenFarmPics/KafenFarm_Candid_Moments_003.webp 1200w"
              sizes="(max-width: 768px) 100vw, 50vw"
              alt="Hiking trail through native vegetation"
              loading="lazy"
        ...
        <div id="pool" className="grid gap-6 md:grid-cols-2 items-center">
          <div className="order-2 md:order-1">
            <div className="rounded-xl overflow-hidden border shadow-card">
              <img
                src="/KafenFarmPics/KafenFarm_Pool_Fun_001.webp"
                srcSet="/KafenFarmPics/KafenFarm_Pool_Fun_001_mobile.webp 600w, /KafenFarmPics/KafenFarm_Pool_Fun_001.webp 1200w"
                sizes="(max-width: 768px) 100vw, 50vw"
                alt="Family-friendly swimming pool area"
                loading="lazy"
                className="h-48 w-full object-cover"
              />
            </div>
        ...
        <div id="market" className="grid gap-6 md:grid-cols-2 items-center">
          ...
          <div className="rounded-xl overflow-hidden border shadow-card">
            <img
              src="/KafenFarmPics/KafenFarm_Braai_and_Prep_008.webp"
              srcSet="/KafenFarmPics/KafenFarm_Braai_and_Prep_008_mobile.webp 600w, /KafenFarmPics/KafenFarm_Braai_and_Prep_008.webp 1200w"
              sizes="(max-width: 768px) 100vw, 50vw"
              alt="Local farmers market with fresh produce and food stalls"
              loading="lazy"
              className="h-48 w-full object-cover"
            />
          </div>
        ...
        <div id="picnic" className="grid gap-6 md:grid-cols-2 items-center">
          <div className="order-2 md:order-1">
            <div className="rounded-xl overflow-hidden border shadow-card">
              <img
                src="/KafenFarmPics/KafenFarm_Grass_Picnic_001.webp"
                srcSet="/KafenFarmPics/KafenFarm_Grass_Picnic_001_mobile.webp 600w, /KafenFarmPics/KafenFarm_Grass_Picnic_001.webp 1200w"
                sizes="(max-width: 768px) 100vw, 50vw"
                alt="Peaceful picnic area under acacia trees"
                loading="lazy"
                className="h-48 w-full object-cover"
              />
            </div>
