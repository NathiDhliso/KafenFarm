      ...
      <section className="container py-12 md:py-16">
        ...
        <div className="mt-8 grid gap-8 md:grid-cols-2">
          <form onSubmit={onSubmit} className="grid gap-4">
            <div>
              <label className="block text-sm font-semibold uppercase tracking-wider text-muted-foreground">Your Name</label>
              <Input id="name" name="name" placeholder="e.g. Nkosinathi" required />
            </div>

            <div>
              <label className="block text-sm font-semibold uppercase tracking-wider text-muted-foreground">Your Email</label>
              <Input id="email" name="email" type="email" placeholder="hello@you.com" required />
            </div>

            <div>
              <label className="block text-sm font-semibold uppercase tracking-wider text-muted-foreground">Subject</label>
              <Input id="subject" name="subject" placeholder="Booking enquiry" />
            </div>

            <div>
              <label className="block text-sm font-semibold uppercase tracking-wider text-muted-foreground">Message</label>
              <textarea
                id="message"
                name="message"
                rows={6}
